  ...
  return (
    <section className="w-full bg-[#f4dcdc] px-6 py-12 lg:px-24 flex flex-col lg:flex-row items-center justify-center mt-20">
      ...
      <div className="w-full lg:w-1/2 mt-10 lg:mt-0 lg:pl-16 text-center lg:text-left">
        <blockquote className="text-4xl font-serif italic text-gray-800 mb-4">
          “Every woman deserves to feel beautiful”
        </blockquote>
        <p className="text-gray-700 mb-4 font-serif text-2xl">
        ...
        <p className="text-gray-700 mb-6 font-serif text-2xl">
          Vivamus fermentum orci vitae libero lacinia, non aliquet sapien
          feugiat. Donec sit amet pharetra justo, sit amet tempor arcu.
        </p>
        <button className="bg-rose-950 text-white px-6 py-3 text-sm rounded cursor-pointer hover:bg-gray-800 transition">
          Meet Roxana
        </button>
      </div>
    </section>
